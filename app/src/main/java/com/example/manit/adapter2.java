...
public class adapter2 extends FragmentPagerAdapter {
    ...
    public adapter2(@NonNull FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        switch (position){
            ...
            case 2: return new ece3();
            case 3: return  new ece4();
            case 4: return  new ece5();
            case 5: return  new ece6();
            case 6: return  new ece7();
            default:{
                return null;
            }
        }
